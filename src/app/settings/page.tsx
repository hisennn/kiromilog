...
export default async function SettingsPage() {
  ...
  return (
    <main className="app-shell animate-fade-in-up">
      <AppHeader avatarUrl={profile.avatarUrl} current="settings" nickname={profile.nickname} username={profile.username} />
      ...
      <section className="section-head animate-fade-in-up animate-delay-100">
        <div>
          ...
          <h1 className="font-display text-4xl text-foreground mt-1">Account settings</h1>
        </div>
        <p className="max-w-xl text-sm leading-7 text-muted mt-2">
          Control your profile photo upload and the maximum file size allowed for your avatar.
        </p>
      </section>
